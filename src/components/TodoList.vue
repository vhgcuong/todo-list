  ...
  <div class="flow-root m-10">
    <dl class="-my-3 divide-y divide-gray-200 text-sm">
      ...
      <div class="grid grid-cols-1 gap-1 py-3 sm:grid-cols-3 sm:gap-4">
        ...
        <dd class="text-gray-700 sm:col-span-2"> Lorem ipsum dolor, sit amet consectetur adipisicing elit. Et facilis
          debitis explicabo doloremque impedit nesciunt dolorem facere, dolor quasi veritatis quia fugit aperiam
